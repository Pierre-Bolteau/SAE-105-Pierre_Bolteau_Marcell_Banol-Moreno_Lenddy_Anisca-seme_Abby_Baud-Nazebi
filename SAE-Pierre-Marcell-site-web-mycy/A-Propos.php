    ...
    <section class="conteneur-1280">
        ...
        <main class="conteneur-principal">
            <ul>
                ...
                <li><a href="#SAÉ">SAÉ</a></li>
                <li><a href="#Exemple de SAÉ">Exemple de SAÉ</a></li>
            </ul>

            <p id="Présentation">Le BUT métiers du multimédia et de l'internet (MMI) remplace le DUT MMI à partir de la rentrée 2021, 
            ...
            <p>Lorsque cette formation était proposée sous la forme d'un Diplôme Universitaire Technologique (DUT), 
            ...
            <div class="conteneur-maison">
                <img class="image-maison" src="ressources/images/maison.jpg" alt="Photo d'une maison canadiene rouge au bord de l'eau en automne">
            </div>

            <p>A CY Cergy Paris Université, il est donné la possibilité aux étudiants de passer un semestre au Québec 
            ...
            <p>La situation d'apprentissage et d'évaluation ou simplement SAÉ est la situation didactique que privilégie, 
            ...
            <p>Les SAE sont une nouveauté des diplômes BUT, elles visent à remplacer les Devoirs Sur Table et les notes à terme, 
